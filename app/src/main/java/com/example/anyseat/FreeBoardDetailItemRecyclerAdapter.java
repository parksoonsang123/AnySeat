...
public class FreeBoardDetailItemRecyclerAdapter extends RecyclerView.Adapter<FreeBoardDetailItemRecyclerAdapter.ViewHolder> {

    private Context context = null;

    private List<FreeBoardDetailItem> mDataList;

    public FreeBoardDetailItemRecyclerAdapter() {}

    public FreeBoardDetailItemRecyclerAdapter(Context context, List<FreeBoardDetailItem> mDataList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FreeBoardDetailItemRecyclerAdapter.ViewHolder holder, int position) {
